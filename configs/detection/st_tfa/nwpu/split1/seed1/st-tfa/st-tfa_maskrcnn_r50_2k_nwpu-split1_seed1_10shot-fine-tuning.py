...
load_from = ('work_dirs/st_rpn_maskrcnn_r50_10k_nwpu-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = f'st-tfa_maskrcnn_r50_nwpu-split1_seed{seed}_{shots}shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
