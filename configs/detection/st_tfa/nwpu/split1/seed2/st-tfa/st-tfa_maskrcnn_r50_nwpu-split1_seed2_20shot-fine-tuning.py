...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/nwpu-split1_20shot_seed{seed}.json',
...
load_from = ('work_dirs/st_rpn_maskrcnn_r50_80k_nwpu-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = f'st-tfa_maskrcnn_r50_nwpu-split1_seed{seed}_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
