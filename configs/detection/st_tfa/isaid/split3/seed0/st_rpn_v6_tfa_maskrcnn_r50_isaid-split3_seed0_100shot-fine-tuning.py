...
expr_name = 'st_rpn_v6_tfa_maskrcnn_r50_isaid-split3_seed0_100shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=200,
             bbox_score_thr=[0.972, 0.972, 0.981, 0.960, 0.981, 0.975, 0.977, 0.995, 0.981, 0.839,
                             0.986, 0.960, 0.854, 0.905, 0.997],
             eval_after_run=True)
    ])
