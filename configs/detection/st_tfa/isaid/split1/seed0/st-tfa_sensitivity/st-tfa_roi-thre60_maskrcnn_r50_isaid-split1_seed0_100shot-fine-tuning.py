...
expr_name = 'st-tfa_roi-thre60_maskrcnn_r50_isaid-split1_seed0_100shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=200,
             # bbox_score_thr=0.0,
             bbox_score_thr=[0.994, 0.930, 0.978, 0.992, 0.992, 0.929, 0.908, 0.950, 0.980, 0.632,
                             0.903, 0.976, 0.052, 0.945, 0.129],
