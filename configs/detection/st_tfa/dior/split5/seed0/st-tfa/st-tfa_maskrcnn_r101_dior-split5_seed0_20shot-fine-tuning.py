...
load_from = ('work_dirs/st_rpn_maskrcnn_r101_40k_dior-split5_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-tfa_maskrcnn_r101_dior-split5_seed0_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=300,
             bbox_score_thr=[0.9945451, 0.9739691, 0.9718596, 0.9697547, 0.95820534, 0.9453671,
                             0.9642433, 0.9779465, 0.9822805, 0.9789481, 0.9721077, 0.9870544,
                             0.9851562, 0.98832583, 0.99790347, 0.9863275, 0.93571687, 0.9699,
                             0.99680305, 0.9144894],
