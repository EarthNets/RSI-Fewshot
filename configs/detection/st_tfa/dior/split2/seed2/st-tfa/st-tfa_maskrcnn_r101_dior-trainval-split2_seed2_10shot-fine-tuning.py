...
load_from = ('work_dirs/st-tfa_maskrcnn_r101_40k_dior-trainval-split2_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-tfa_maskrcnn_r101_40k_dior-trainval-split2_seed2_10shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
