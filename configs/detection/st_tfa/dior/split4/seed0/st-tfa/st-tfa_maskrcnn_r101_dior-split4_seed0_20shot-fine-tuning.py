...
load_from = ('work_dirs/st_rpn_maskrcnn_r101_40k_dior-split4_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-tfa_maskrcnn_r101_dior-split4_seed0_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=300,
             bbox_score_thr=[0.99308956, 0.96024716, 0.9899254, 0.9820819, 0.95439565, 0.96304524,
                             0.9926491, 0.8768542, 0.9701952, 0.9663818, 0.9818872, 0.95777786,
                             0.89550865, 0.9870283, 0.9730196, 0.97559136, 0.9575695, 0.8848994,
                             0.5186359, 0.05093428],
