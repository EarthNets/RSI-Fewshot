...
load_from = ('work_dirs/neg_rpn_tfa_maskrcnn_r50_20k_dior-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'neg_rpnv2_tfa_maskrcnn_r50_dior-split1_bs8_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
