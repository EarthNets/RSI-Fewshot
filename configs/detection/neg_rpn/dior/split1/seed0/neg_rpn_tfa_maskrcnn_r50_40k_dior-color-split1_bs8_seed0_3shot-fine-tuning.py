...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-color-split1_3shot_seed{seed}.json'
    ),
...
load_from = ('work_dirs/tfa_maskrcnn_r50_40k_dior-color-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'neg_rpn_tfa_maskrcnn_r50_40k_dior-color-split1_bs8_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
