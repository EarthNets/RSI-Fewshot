...
load_from = ('work_dirs/tfa_r101_40k_fpn_dior_fine-tuning/base_model_random_init_bbox_head.pth')

expr_name = 'tfa_40k_r101_fpn_dior-split1_seed0_3shot-fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
