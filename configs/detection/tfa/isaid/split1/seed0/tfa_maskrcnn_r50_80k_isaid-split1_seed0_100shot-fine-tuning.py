...
expr_name = 'tfa_maskrcnn_r50_80k_isaid-split1_seed0_100shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=200,
             bbox_score_thr=[0.115, 0.053, 0.078, 0.064, 0.059, 0.307, 0.361, 0.462, 0.187, 0.089,
                             0.492, 0.142, 0.051, 0.065, 0.050],
             # bbox_score_thr=0.0,
