...
load_from = ('work_dirs/st_rpn_maskrcnn_r101_20k_isaid-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st_rpn_v2_rpn-ignore_roi-ignore_tfa_maskrcnn_r101_isaid-split1_seed0_10shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
