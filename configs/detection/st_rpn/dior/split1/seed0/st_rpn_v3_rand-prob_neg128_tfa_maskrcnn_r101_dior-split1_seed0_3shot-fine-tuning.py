...
model = dict(
    ...
    frozen_parameters=[
        ...
        'rpn_head.rpn_conv_stu.weight',
        'rpn_head.rpn_conv_stu.bias',
        'rpn_head.rpn_reg_stu.weight',
        'rpn_head.rpn_reg_stu.bias',
...
expr_name = 'st_rpn_v3_rand-prob_neg128_tfa_maskrcnn_r101_dior-split1_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
