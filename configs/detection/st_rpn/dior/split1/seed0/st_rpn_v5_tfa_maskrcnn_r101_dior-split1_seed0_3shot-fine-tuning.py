...
load_from = ('work_dirs/st_rpn_maskrcnn_r101_20k_dior-split1_randomized_head_v2/base_model_random_init_bbox_head.pth')

expr_name = 'st_rpn_v5_tfa_maskrcnn_r101_dior-split1_seed0_3shot_fine-tuning'
# expr_name = 'st_rpn_v3_fixed-rpn_rpn-128_bg-00_st-00_base-loss_rpn-st-100_tfa_maskrcnn_r101_dior-split1_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
