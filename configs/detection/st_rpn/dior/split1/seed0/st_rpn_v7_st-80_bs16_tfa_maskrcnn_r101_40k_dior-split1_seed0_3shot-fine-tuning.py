_base_ = [
    '../../../../_base_/datasets/fine_tune_based/few_shot_dior_bs16.py',
    '../../../../_base_/schedules/adamw_5k.py',
    '../../../tfa_maskrcnn_r50.py',
...
load_from = ('work_dirs/st_rpn_maskrcnn_r101_40k_dior-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st_rpn_v7_st-80_bs16_tfa_maskrcnn_r101_40k_dior-split1_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
