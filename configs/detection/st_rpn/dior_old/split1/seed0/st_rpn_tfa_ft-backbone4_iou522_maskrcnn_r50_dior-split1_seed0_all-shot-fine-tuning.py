...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-split1_all-shot_seed{seed}.json'
    ),
...
model = dict(
    ...
    frozen_parameters=[
        ...
        'backbone.layer2',
        'backbone.layer3',
        'neck', 'rpn_head.rpn_reg', 'roi_head.bbox_head.shared_fcs'
    ],
    rpn_head=dict(
        type='STRPNHead',
        st_thre=0.1
...
expr_name = 'st_rpn_tfa_ft-backbone_iou522_maskrcnn_r50_dior-split1_seed0_all-shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
