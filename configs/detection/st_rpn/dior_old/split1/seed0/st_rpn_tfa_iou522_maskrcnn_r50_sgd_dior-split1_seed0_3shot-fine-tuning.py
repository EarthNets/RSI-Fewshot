...
model = dict(
    type='NegRPNTFA',
    frozen_parameters=[
        'backbone', 'neck', 'rpn_head.rpn_reg', 'roi_head.bbox_head.shared_fcs'
    ],
    rpn_head=dict(
        type='STRPNHead',
        st_thre=0.1
...
load_from = ('work_dirs/tfa_maskrcnn_r50_SGD_20k_dior-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st_rpn_tfa_iou522_maskrcnn_r50_sgd_dior-split1_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
